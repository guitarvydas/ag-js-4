...
<html>
  ...
  <body>
    ...
    <svg width="800" height="800">
      ...
      <text id="id7" x="50" y="150"></text>
      <text id="id8" x="50" y="350"></text>
      <text id="id9" x="290" y="185"></text>
      <text id="id10" x="660" y="150"></text>
      <text id="id11" x="660" y="320"></text>
      <text id="id12" x="660" y="410"></text>
      <text id="id13" x="660" y="490"></text>
